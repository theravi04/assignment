...
export default function Middle({ rank, percentile, correct, onSaveScore }) {
  ...
  return (
    <div className="flex flex-col bg-red-300 ml-11 w-2/4 space-y-6">
      <div className="flex justify-start items-center h-10 bg-gray-500 mt-6">
        <h1>Skill Test</h1>
      </div>

      <div className="flex flex-row bg-slate-500 h-1/6 rounded-md justify-between items-center">
      ...
      {/* second div */}
      <div className="flex flex-col bg-red-400 h-1/5 rounded-md space-y-3">
        <div>
          <h1 className="font-extrabold bg-slate-400 ml-7 mt-3">
            Quick Statistics
          </h1>
        </div>
        <div className="flex flex-row justify-between bg-gray-400 items-center">
          <div className="flex flex-row justify-between space-x-3 items-center ml-12">
            ...
            <div className="flex flex-col justify-center">
              <div>
                <h1 className="font-extrabold text-xl">{rank}</h1> {/* Updated rank */}
              </div>
              <div>Your Rank</div>
            </div>
          </div>
          <div className="flex flex-row justify-between space-x-3 items-center">
            ...
            <div className="flex flex-col justify-center">
              <div>
                <h1 className="font-extrabold text-xl">{percentile}%</h1> {/* Updated percentile */}
              </div>
              <div>Percentile</div>
            </div>
          </div>
          <div className="flex flex-row justify-between space-x-3 items-center mr-12">
            ...
            <div className="flex flex-col justify-center">
              <div>
                <h1 className="font-extrabold text-xl">{correct}/{15}</h1> {/* Updated correct answers */}
              </div>
      ...
      />
      <div className="flex flex-row h-2/4 rounded-md">
        <ComparisonGraph
